...
1. **Войти как admin:**
   ...
   - Должны быть видны все кнопки (Создать, Редактировать, Удалить)

2. **Войти как viewer:**
   - Логин: `viewer`, Пароль: `viewer`
   - Кнопки создания/редактирования/удаления должны быть скрыты
   - Можно только просматривать товары
